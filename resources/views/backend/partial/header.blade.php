<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fw-bolder bg-secondary" href="#">Travalicious Admin Area</a>
    ...
    <ul class="navbar-nav px-3">
        <li class="nav-item text-nowrap">
            @auth()
                ...
                <a style="color:white; margin-right: 60px;" class="btn btn-danger" href="{{ route('logout') }}"> Logout</a>
            @else
